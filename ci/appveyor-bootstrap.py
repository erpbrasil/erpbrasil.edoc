"""
AppVeyor will at least have few Pythons around so there's no point of implementing a
bootstrapper in PowerShell.

This is a port of
https://github.com/pypa/python-packaging-user-guide/blob/master/source/code/install.ps1
with various fixes and improvements that just weren't feasible to implement
in PowerShell.
"""
...
def download_file(url, path):
    ...
    def report(count, size, total):
        ...
        if progress[0] - progress[1] > 1000000:
            ...
            print(f"Downloaded {progress[1]:,}/{total:,} ...")

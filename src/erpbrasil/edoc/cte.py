...
try:
    ...
    from nfelib.cte.bindings.v4_0 import RetConsStatServCte
    from nfelib.cte.bindings.v4_0 import TconsSitCte
    from nfelib.cte.bindings.v4_0 import RetConsSitCte
    from nfelib.cte.bindings.v4_0 import Tcte

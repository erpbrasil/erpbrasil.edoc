...
try:
    ...
    from erpbrasil.nfelib_legacy.v4_00.retEnvConfRecebto import (
        TEnvEvento as TEnvEventoManifestacao,
    )
    from erpbrasil.nfelib_legacy.v4_00.retEnvConfRecebto import (
        TEvento as TEventoManifestacao,  # noga
    )
    from erpbrasil.nfelib_legacy.v4_00.retEnvConfRecebto import (
        descEventoType as descEventoManifestacao,
    )
    from erpbrasil.nfelib_legacy.v4_00.retEnvConfRecebto import (
        detEventoType as detEventoManifestacao,
    )
    from erpbrasil.nfelib_legacy.v4_00.retEnvConfRecebto import (
        infEventoType as infEventoManifestacao,
    )
    from erpbrasil.nfelib_legacy.v4_00.retEnvConfRecebto import (
        tpEventoType as eventoManifestacao,
    )
except ImportError:
    pass
